    ...
    return (
        ...
        <div id="about" className="container-fluid mt-4">
            <div id="row-height" className="row d-flex justify-content-center my-2">
                ...
                <div id="img-frame" className="my-1 col-xl-7 col-lg-7 col-md-6 col-sm-12 col-12" style={img[0]} ></div>
            </div>
            ...
            <div id="row-height" className="row d-flex justify-content-center my-2">
                <div className="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 d-flex flex-column justify-content-center">
                    ...
                    <div className="row">
                        <NavLink className="col-xl-4 col-lg-6 col-md-4 col-sm-4 col-4 btn btn-warning text-dark ml-2 p-2" to="/api/v1/slogans/new">Slogan contest</NavLink>
                    </div>
                </div>
                <div id="img-frame" className="my-1 col-xl-7 col-lg-7 col-md-6 col-sm-12 col-12" style={img[2]} ></div>
            </div>
